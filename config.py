...
def config_parser():
    ...
    ########## evaluation options ##########
    parser.add_argument("--distributed_init_method", type=str, default='env://',
                        help='init distributed training')
    
    parser.add_argument("--llffhold", type=int, default=8,
                        help='will take every 1/N images as LLFF test set, paper uses 8')

    parser.add_argument("--llff_factor", type=int, default=4,
                        help='downsample factor for llff')

    parser.add_argument('--random_crop', action='store_true', help='whether to use random_crop in training')
...
#     parser.add_argument("--attack_mode", type=str, choices=['view_specific', 'image_specific', 'no_attack'], default='view_specific',
#                         help='specify the attack mode')
    ...
    parser.add_argument('--use_center_view', action='store_true', help='use center views as source views under the generalizable setting')
